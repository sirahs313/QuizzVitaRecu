...
{
    public partial class respuestasDepresion : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Session["RespuestasDepresion"] != null)
                {
                    List<int> respuestas = (List<int>)Session["RespuestasDepresion"];
