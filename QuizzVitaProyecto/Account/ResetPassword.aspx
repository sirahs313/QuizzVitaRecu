<%@ Page Title="Restablecer contraseña" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="QuizzVitaProyecto.Account.ResetPassword" Async="true" %>
        ...
        <div>
            ...
            <div class="row">
                <div class="offset-md-2 col-md-10">
                    <asp:Button runat="server" OnClick="Reset_Click" Text="Restablecer" CssClass="btn btn-outline-dark" />
                </div>
            </div>
        </div>
    </main>
